...
<a
  ...
  class="col-span-2 sm:col-span-1 scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-lime-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow shadow-lime-500/20 dark:shadow-none flex h-full motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-lime-500"
  wire:navigate>
